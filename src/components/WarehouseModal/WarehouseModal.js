      ...
      <div className="Modal">
        <div className="Modal__wrapper">
          ...
          <div className="Modal__content">
            <h1 className="Modal__title">Delete Washington {type === 'warehouse' ? 'warehouse' : 'inventory item'}?</h1>
            <p className="Modal__text">
              Please confirm that you’d like to delete the Washington from the
              list of {type === 'warehouse' ? 'warehouses' : 'inventory items'}. You won’t be able to undo this action.
            </p>
          </div>
